...
public class EcoControll {
   ...
   public EcoDto login(EcoDto data) {
      ...
      // SQL 실행 --?
      String sql = "SELECT E.NO, E.ID, E.NAME, E.NICK, E.GENDER, E.PHONE, B.BANKNAME, E.ACCOUNT, E.POINT, E.ADDEDPOINT, E.ENROLL_DATE, R.RANK\r\n"
      		+ "FROM ECO_MEMBER E\r\n"
      		+ "JOIN BANKCODE B ON E.BANKNO = B.BANKNO\r\n"
