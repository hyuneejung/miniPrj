...
public class EcoDto {
	...
	public EcoDto(String id, String pwd, String name, String nick, String gender, String phone, String bank,
			String account, int point, int addedPoint, Timestamp enroll_date, String rank, char quit_yn) {
...
//	int addedPoint = rs.getInt("ADDED_POINT");
//	Timestamp enrolldate = rs.getTimestamp("ENROLL_DATE");
//	String rank = rs.getString("RANK");
//	char quit_yn = rs.char("QUIT_YN");
//			
