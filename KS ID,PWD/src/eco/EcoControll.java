...
public class EcoControll {
	...
	public void findUser() {
		...
		System.out.print("이름 : ");
		String name = InputUtill.getString();
		System.out.print("전화번호 : ");
		String phone = InputUtill.getString();

		String rdn = InputUtill.randomNum(6, 1);
		System.out.println(" 인증번호 6자리 ::" + rdn);
		System.out.print("입력번호 ::::");

		String rdnCheck = InputUtill.getString();
	...
	public void changePwd2() {
		...
		String id = InputUtill.getString();
		...
		if (rdnCheck.equals(rdn)) { // 인증번호 일치
			...
			String chPwd = InputUtill.getString();
			System.out.print("비밀번호를 한번더 입력해주세요");
			String chPwd2 = InputUtill.getString();
